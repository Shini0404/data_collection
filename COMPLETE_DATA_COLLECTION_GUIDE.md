...
1. Edit → Project Settings → Meta XR (or Oculus)
2. Ensure these are enabled:
   - Eye Tracking: "Required"
   - Face Tracking: "Supported"

3. If you need to manually edit the manifest:
   - Go to: Assets/Plugins/Android/AndroidManifest.xml
   - If it doesn't exist, the Meta SDK creates it at build time
